...
class CI_Cart {
	...
	function update_data($items = array()){
		...
		$this->_cart_contents[$items['rowid']]['lugar'] = $items['lugar'];
		$this->_cart_contents[$items['rowid']]['telefono'] = $items['telefono'];
		$this->_cart_contents[$items['rowid']]['personas'] = $items['personas'];
		$this->_cart_contents[$items['rowid']]['fecha_transporte'] = $items['fecha'];
		$this->_cart_contents[$items['rowid']]['hora']  = $items['hora'];
		$this->_cart_contents[$items['rowid']]['obs']   = $items['obs'];
