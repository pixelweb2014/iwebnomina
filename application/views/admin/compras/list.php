<div class="block">
    ...
    <div class="block_head">
        ...
        <ul>
            ...
            <li><a href="compras/nueva">Nueva Compra</a></li>
        </ul>
        <ul>
           ...
           <li>Proveedor: <select id="proveedor" style="width:110px">
            		<option value="">Todas</option>
                    <?php
					foreach($proveedores as $kc){
						?><option value="<?php echo $kc['id_proveedor'] ?>"><?php echo $kc['nom_proveedor'] ?></option><?php
					}
					 ?>
            </select>
    ...
    <script type="text/javascript">
    	$(document).ready(function(){
						...
						success: function(data){ 
							if(data.length > 0){
								...
								$.each(data, function(i,item){
									html += '<tr class="rows"><td></td><td>'+item.num_compra+'</td><td>'+item.nom_proveedor+'</td><td style="text-align:right">'+item.monto+'</td><td style="text-align:center">'+item.fecha_compra+'</td><td><a href="compras/ver/'+item.id+'" class="tip" title="Ver"><img src="public/admin/images/bver.png" /></a></td></tr>';
			...
			search_Compra($("#proveedor").find("option:selected").val(),$("#fechai").val(),$("#fechaf").val(),0);
