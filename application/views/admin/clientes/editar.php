        ...
        <?php } ?>
			<form method="post" action="clientes/actualizar/" enctype="multipart/form-data" id="form_cli">                
                ...
                <div style="float:left; width:450px">
                    ...
                    <p>
                  <label>Razon social</label><br /> <input type="text" name="nom_cliente"  size="55" class="text required alpha" value="<?php echo $data[0]['nom_cliente'] ?>">
				  </p>
                    
                    <p>
                  <label>Nombre contacto</label><br /> <input type="text" name="ape_cliente" size="55" class="text required alpha" value="<?php echo $data[0]['ape_cliente'] ?>">
				  </p>
