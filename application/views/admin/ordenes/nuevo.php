	  ...
	  <script type="text/javascript">
        ...
        <?php } ?>
			<form method="post" action="ordenes/agregar" enctype="multipart/form-data" id="form_new_p" name="form_new_p" > 
                ...
                <div style="width:50%; float:left">
                    <p><label> Hora de salida</label><br /> <input required type="text" id="timep1" name="hora_salida" class="text "  value="<?php echo $data[0]['hora_salida'] ?>"><span class="add-on"><i class="icon-time"></i></span></p>
                    <p><label> Hora de llegada al cliente</label><br /> <input required id="timep2" type="text" name="hora_llegada_cliente" class="text "  value="<?php echo $data[0]['hora_llegada_cliente'] ?>"><span class="add-on"><i class="icon-time"></i></span></p>
                    <p><label> Hora salida cliente</label><br /> <input required id="timep3" type="text"   name="hora_salida_cliente" class="text "  value="<?php echo $data[0]['hora_salida_cliente'] ?>"><span class="add-on"><i class="icon-time"></i></span></p>
                    <p><label> Hora llegada</label><br /> <input required id="timep4" type="text"   name="hora_llegada" class="text "  value="<?php echo $data[0]['hora_llegada'] ?>"><span class="add-on"><i class="icon-time"></i></span></p>
