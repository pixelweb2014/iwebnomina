<div class="block">
    ...
    <div class="block_content" id="new">                
	  <script type="text/javascript">
		...
		$(document).ready(function(){
        	...
        	$(function() {
				...
				$("#buscar_prod_serv").click(function() {
					$('<a href="ajax/search_prod_serv/compras"></a>').facebox({
						overlayShow: true
					}).click();
        ...
        <?php } ?>
			<form method="post" action="../compras - Copia/compras/agregar" enctype="multipart/form-data" id="form_new_c" name="form_new_c"> 
