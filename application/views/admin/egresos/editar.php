<div class="block">
    ...
    <div class="block_head">
        ...
        <h2>Facturas</h2>
        <ul>
            <li class="active"><a href="../compras - Copia/facturas">Listar</a></li>
            <li><a href="../compras - Copia/facturas/nueva">Crear Factura</a></li>
    ...
    <div class="block_content">
        ...
        <?php } ?>
	  <form method="post" action="../compras - Copia/facturas/actualizar" enctype="multipart/form-data"> 
