<div class="block">
    ...
    <div class="block_head">
        ...
        <ul>
        	<li><a href="facturas">Contado</a></li>
            <li class="active"><a href="facturas/creditos">Cr&eacute;dito</a></li>            
    ...
    <script type="text/javascript">
    	$(document).ready(function(){
						...
						success: function(data){ 
							if(data.length > 0){
								...
								$.each(data, function(i,item){
									html += '<tr class="rows"><td></td><td>'+item.num_factu_venta+'</td><td>'+item.nom_cliente+'</td><td style="text-align:right">'+item.monto+'</td><td style="text-align:center">'+item.fecha_venta+'</td><td><a href="facturas/ver/'+item.id+'" class="tip" title="Ver"><img src="public/admin/images/bver.png" /></a>&nbsp; </td></tr>';
									
									
									//Para eliminar e imprimir facturas
									//<a href="facturas/editar/'+item.id+'" class="tip" title="Editar"><img src="public/admin/images/bedit.png" /></a>	<a href="facturas/eliminar/'+item.id+'" class="tip"  title="Eliminar" onclick="return delete_row()"><img src="public/admin/images/bdelete.png" /></a>&nbsp; <a href="facturas/imprimir/'+item.id+'" class="tip"  title="Imprimir"><img src="public/admin/images/pdf.png" /></a>
			...
			search_factura($("#clientes").find("option:selected").val(),$("#fechai").val(),$("#fechaf").val());
