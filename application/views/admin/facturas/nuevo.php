...
<div class="block">
   ...
   <div class="block_content" id="new">                
	  <script type="text/javascript">
        ...
        <?php } ?>
			<form method="post" action="facturas/agregar/" enctype="multipart/form-data" id="form_new_p" name="form_new_p" target="_blank"> 
             ...
             <div style="width:100%; float:left"> 
                                ...
                                <br clear="all" />
                <p>
                	<label>Condici&oacute;n de pago</label>  <select class="styled" name="condicion_pago"><option value="0"  <?php echo ($data[0]['condicion_pago'] == 0) ? "selected='selected'":"" ?>>Contado</option><option value="1"  <?php echo ($data[0]['condicion_pago'] == 1) ? "selected='selected'":"" ?>>Crédito</option></select>
                </p>
            </div> 
              </div>
             ...
             <p align="right"><input type="button" class="submit extra_long" id="buscar_prod_serv" value="Añadir Producto" /></p>
				...
				<table cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tbody id="detalle">
                    	<tr class="nothing">
                        	<td style="text-align:center" colspan="4">Sin detalle</td>
                            <td></td>
                            <td></td>
                        </tr>
                    </tbody>
