<form method="post" action="reservaciones/crear_factura">
<div class="block">
    ...
    <div class="block_head">
        ...
        <ul>
            ...
            <li><a href="reservaciones/nueva">Crear Orden</a></li>
            <li><button type="submit">Crear Factura</button></li>
        </ul>
        <ul>
    ...
    <script type="text/javascript">
		function search_factura(q, fi, ff, t){
			...
			$.ajax({
				...
				type: "POST",
				dataType: "json",
				url: "reservaciones/listar",
					success: function(data){ 
						if(data.length > 0){
							var html ='', sum=0;
							$.each(data, function(i,item){
								var d = (item.abonos == item.saldo && item.generado == 'No') ? '<a href="reservaciones/generar/'+item.id+'" class="tip" title="Generar Factura"><img src="public/admin/images/document-new.png" /></a>' : '<a href="javascript:;" class="tip" title="Generar Factura"><img src="public/admin/images/document-d.png" /></a>';
								
								html += '<tr class="rows"><td><input type="checkbox" name="ordenes[]" value="'+item.numero+'"> </td><td>'+item.numero+'</td><td>'+item.nom_cliente+'</td><td style="text-align:right">'+item.estado+'</td><td style="text-align:center">'+item.fecha_reservacion+'</td><td><a href="reservaciones/ver/'+item.id+'" class="tip" title="Ver"><img src="public/admin/images/bver.png" /></a>&nbsp; <a href="reservaciones/abonos/'+item.id+'" class="tip box" title="Abonar"><img src="public/admin/images/abonos.png" /></a>&nbsp;  '+d+'</td></tr>';
