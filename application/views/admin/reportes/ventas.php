...
<div class="block">
    ...
    <div class="block_head">
        ...
        <ul>
            ...
            <li><a>Ver</a> 
                <select style="padding:2px;width:200px" id="ver">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#ver,#fechai,#fechaf").change(function(){
			filtrar()
		})
		...
		function filtrar(){
			...
			$.post("reportes/ventas_list",{q:q,v:v,fi:fi,ff:ff},function(data){
				$("#load").html(data)
				$("#mask").unmask()
			})
		}
	...
	function print_(){
		...
		var fi = $("#fechai").val();
		var ff = $("#fechaf").val();
		window.open('reportes/ventas_print/'+v+'/'+fi+' '+ff+'/'+q)	
	}
</script>