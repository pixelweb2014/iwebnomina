...
<div class="block">
    ...
    <div class="block_head">
        ...
        <ul class="tabs">
            ...
            <li <?php if($tab == 'nuevo') echo 'class="active"'?>><a href="#new">Nueva Categoria</a></li>
        </ul>
        <ul>
          ...
          <table cellpadding="0" cellspacing="0" width="100%" class="sortable_list">
            ...
            <tbody>
              ...
              <tr class="rows">
                ...
                <td class="options"><a href="departamentos/editar/<?php echo $key['id_depto'] ?>" class="tip" title="Editar"><img src="public/admin/images/bedit.png" /></a> <a href="departamentos/eliminar/<?php echo $key['id_depto'] ?>" class="tip"  title="Eliminar" onclick="return delete_row()"><img src="public/admin/images/bdelete.png" /></a></td>
              </tr>
              <?php 
					}
				   } ?>
    ...
    <div class="block_content tab_content  <?php if($tab != 'nuevo') echo 'hide'?>" id="new">
        ...
        <?php } ?>
			<form method="post" action="departamentos/agregar/" enctype="multipart/form-data" id="form_cli"> 
            	<div style="float:left; width:450px">
                <p>Categoria<br/> <input type="text" name="nom_depto"  size="55" class="text required alpha"></p>
                  <p>&nbsp;</p>
                  <br clear="all" />
            	</div>            	
                <hr>
